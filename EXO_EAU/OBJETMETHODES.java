 ...
 * quantité (en cl)
 * Est ouvert ( Oui ou non) //Boolean
 * Est vide ( Oui ou non) // Boolean
 * 
 * Son comportement ::
 * 
 * Ouvrir
 ...
 * 
 * Bonus : Ajouter si vous oubliez de fermer la bouteille, il faudrait lancer aléatoirement une méthode Vider, qui vide le contenu de votre bouteille 
 * (Afficher un message "Oups! la bouteille s'est vidé accidentellement"),
